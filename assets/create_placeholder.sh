#!/bin/bash
# Create minimal valid PNG files using base64 encoded 1x1 pixel PNGs
# 1x1 blue pixel PNG (icon)
echo "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==" | base64 -d > icon.png
# 1x1 white pixel PNG (splash)
echo "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8z8DwHwAFBQIAX8jx0gAAAABJRU5ErkJggg==" | base64 -d > splash.png
# 1x1 blue pixel PNG (favicon)
